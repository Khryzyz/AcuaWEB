...
class ErrorHandler
{
    ...
    private $levels = array(E_DEPRECATED => 'Deprecated', E_USER_DEPRECATED => 'Usuario Deprecated', E_NOTICE => 'Notice', E_USER_NOTICE => 'Usuario Notice', E_STRICT => 'Runtime Notice', E_WARNING => 'Warning', E_USER_WARNING => 'Usuario Warning', E_COMPILE_WARNING => 'Compile Warning', E_CORE_WARNING => 'Core Warning', E_USER_ERROR => 'Usuario Error', E_RECOVERABLE_ERROR => 'Catchable Fatal Error', E_COMPILE_ERROR => 'Compile Error', E_PARSE => 'Parse Error', E_ERROR => 'Error', E_CORE_ERROR => 'Core Error');
