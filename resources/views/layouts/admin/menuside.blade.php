<div class="p-l-0 p-r-0 collapse in" id="sideAcuaponia">
    ...
    <div class="list-group panel">
        ...
        <div class="collapse" id="menuConfiguracion">
            <a href="/configuracion/procesos" class="list-group-item" data-parent="#menuConfiguracion">
    ...
    <div class="list-group panel">
        ...
        <div class="collapse" id="menu1">
            ...
            <div class="collapse" id="menu1sub1">
                ...
                <a href="#menu1sub1sub1" class="list-group-item" data-toggle="collapse" aria-expanded="false">Subitem 3
                    c </a>
                ...
                <a href="#menu1sub1sub2" class="list-group-item" data-toggle="collapse" aria-expanded="false">Subitem 5
                    e </a>
...
<!--
<li>
    <a href="/muestras"><i class="fa fa-pencil-square-o"></i> Sensores y graficas</a>
</li>
<li>
    <a href="/videos"><i class="fa fa-video-camera"></i> Videos </a>
</li>
<li>
    <a href="/Control"><i class="fa fa-cog" aria-hidden="true"></i> Controles </a>
</li>
-->